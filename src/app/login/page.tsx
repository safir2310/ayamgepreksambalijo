          ...
          >
            <Card className="border-2 border-orange-100 shadow-xl bg-white/95 backdrop-blur-sm">
              <CardContent className="p-8">
                {/* Role Toggle */}
                <div className="grid grid-cols-3 gap-1 bg-orange-50 rounded-lg p-1 mb-6">
                  <button
                    onClick={() => setRole('user')}
                    className={`flex items-center justify-center gap-1.5 py-2.5 px-2 rounded-md transition-all duration-300 text-xs sm:text-sm ${
                      role === 'user'
